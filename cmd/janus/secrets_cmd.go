...
func newSecretsCmd() *cobra.Command {
	...
	cmd.AddCommand(newSecretsListCmd(), newSecretsGetCmd(), newSecretsSetCmd(), newSecretsDeleteCmd(), newSecretsDownloadCmd(), newSecretsLockCmd(), newSecretsUnlockCmd(), newSecretsDiffCmd())
	return cmd
}
